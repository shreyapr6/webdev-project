...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="event_style.php">
...
<body>
  ...
  <div id = "side-menu" class="side-nav">
    ...
    <ul>
			<li><a href=""  onclick="closeSlideMenu()"><i class="far fa-list-alt"></i> Events</a></li>
      ...
      <body>  
           <br /><br />  
                ...
                <h3>  
                     ...
                     <br /><br />  
                     <div class="row" id="show_event">  
                          <?php echo fill_event($connect);?>  
                     </div>  
                </h3>  
